...
class ParserPylowChemii(ParserPomiaru):
    ...
    def ustalNazwyCzynnikow(self):
        "Ustala nazwy czynników dla parsowanego pomiaru i zapisuje je jako krotkę (1 listę i obiekt None jeśli pomiar posiada tylko tablę lub 2 listy jeśli pomiar posiada również tabelę NDSch) w tym parserze"
        nazwy_czynnikow = []
    ...
    def sprawdzCzyNowyPyl(self, wiersz):
        ...
        # szukana informacja jest pierwszej kolumnie
        jest_nowym = False
        kolumna = wiersz.kolumny[0] 
